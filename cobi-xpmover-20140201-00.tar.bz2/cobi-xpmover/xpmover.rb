...
if windrives.size < 1
	info_dialog("Kein geeignetes Quelllaufwerk", "Es wurde keine Festplatte mit installiertem XP gefunden. Möglicherweise ist das System beschädigt oder auf einem nicht unterstützten RAID installiert. Wenden Sie sich ggf. per Email an den Entwickler dieses Tools, Mattias Schlenker, ms@mattiasschlenker.de")
	system("shutdown-wrapper.sh &")
elsif tgtlist.size < 1
