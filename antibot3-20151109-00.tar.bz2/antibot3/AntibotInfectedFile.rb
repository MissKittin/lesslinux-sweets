...
class AntibotInfectedFile
	...
	def initialize(path, mountpoint, uuid, infection, scanparams, fileout=nil, logdb=nil, tstamp=0, act=nil, fulllog=[])
		...
		lang = "en" if lang.nil?
		tlfile = "AntibotInfectedFile.xml"
		tlfile = "/usr/share/lesslinux/antibot3/AntibotInfectedFile.xml" if File.exists?("/usr/share/lesslinux/antibot3/AntibotInfectedFile.xml")
