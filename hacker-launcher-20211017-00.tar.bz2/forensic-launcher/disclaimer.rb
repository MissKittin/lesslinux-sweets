...
disclabel.set_markup("<span color='white'>" + tl.get_translation("wintitle") + "</span>")
...
# scrolled_win.add(textview)
scrolled_win.set_size_request(685, 385)
fixed.put(scrolled_win, 328, 190)
fixed.put(disclabel, 330, 160)
...
button_box.set_size_request(681, 32)
fixed.put(button_box, 330, 580)
